...
export const Adventure = ({ navigation }) => {
  ...
  const fetchData = async () => {
    await fetch(
      "https://api.simkl.com/tv/genres/adventure/all-years?client_id=a4a932f81c143783f6fdc6d3dbe315d441e04f4e3d63578673ef818456798b4a",
      {
        method: "GET",
        headers: {
      ...
      .catch((error) =>
        console.log("problem fetching tv data at Adventure.js" + error)
      );
  };
